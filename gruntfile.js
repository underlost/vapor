...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    coffee: {
      compile: {
        files: {
          'vapor/static/js/app.js': 'static_assets/coffee/app.coffee', // 1:1 compile
          // 'vapor/static/js/app.js': ['static_assets/coffee/*.coffee'] // compile and concat into single file
        }
      },
    },
    ...
    git_deploy: {
      github: {
        options: {
          url: 'git@github.com:underlost/vapor.git',
          branch: 'gh-pages',
